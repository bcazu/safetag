...
> El nombre viene del *safety tagging* del protocolo ATC-20:
> 🟢 habitable · 🟡 uso restringido · 🔴 inseguro.
...
- **Captura**: KoboCollect (Android, offline) con formulario ATC-20 → webhook.
...
kobo/           XLSForm del formulario ATC-20
